...
export default function ShowDetailsModal(props) {
  const { displayShowDetailsModal, toggleShowDetailsModal, yamlErrorDetails, deployView, showDeployWarningModal, showSkipModal, forceDeploy, slug } = props;
              ...
              <div className="flex flex1 alignItems--center u-borderBottom--gray darker u-paddingTop--10 u-paddingBottom--10" key={i}>
                ...
                <div className="flex flex-column u-marginLeft--10">
                  <div className="flex flex1 alignItems--center">
                    ...
                    <Link to={`/app/${slug}/tree/1?${err.path}`}className="replicated-link u-marginLeft--5  u-marginTop--5 u-fontSize--small"> View </Link>
                  </div>
